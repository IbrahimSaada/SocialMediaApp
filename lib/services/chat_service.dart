...
class ChatService {
  final String chatBaseUrl = 'https://8dcc-185-89-86-31.ngrok-free.app/api/Chat';
  final String messageBaseUrl = 'https://8dcc-185-89-86-31.ngrok-free.app/api/Message';
